   ...
   ?>
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Ajouter Propriété</h5>
                    ...
                    <div>
                        ...
                        <div class="modal fade" id="staticBackdrop2" data-bs-backdrop="static" data-bs-keyboard="false"
                                    ...
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="staticBackdropLabel">Ajouter Appartemetnt</h5>
                                    ...
                                    <form>
                                    <div class="mb-3">
                                    <label for="formrow-firstname-input" class="form-label">Propriétaire</label>
                                ...
                                <div class="mb-3">
                                    <label for="formrow-firstname-input" class="form-label">Informations additionnelles</label>
                                    <input type="textarea" class="form-control" id="formrow-firstname-input">
                                </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="mb-3">
                                            ...
                                            <select id="formrow-inputState" class="form-select">
                                                ...
                                                <option>Habité</option>
                                                <option>Location</option>
                                                <option>Non Habité</option>
                                            </select>
                                        </div>
                                    </div>
        ...
        <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false"
                                    ...
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="staticBackdropLabel">Ajouter Immeuble</h5>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                    aria-label="Close"></button>
                                            </div>
                                            <div class="modal-body">
...
<br/>
<br/>
<h4 class="card-title">Immeubles</h4>
<br/>
<br/>
<br/>
